...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Mr.Bendy", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Mr.Bendy", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Mr.Bendy";
		app.meta["name"] = "FNF vs Mr.Bendy";
