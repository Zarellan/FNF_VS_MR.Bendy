...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_3295_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",3295,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_3307_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",3307,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup,int color){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_3295_new)
HXLINE(3297)		this->disableTime = ((Float)6);
HXLINE(3300)		this->parentGroup = parentGroup;
HXLINE(3301)		super::__construct(10,10,0,text,16,null());
HXLINE(3302)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(3302)		::String _hx_tmp;
HXDLIN(3302)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(3302)			_hx_tmp = file;
            		}
            		else {
HXLINE(3302)			_hx_tmp = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(3302)		this->setFormat(_hx_tmp,16,color,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(3303)		{
HXLINE(3303)			 ::flixel::math::FlxBasePoint this1 = this->scrollFactor;
HXDLIN(3303)			this1->set_x(( (Float)(0) ));
HXDLIN(3303)			this1->set_y(( (Float)(0) ));
            		}
HXLINE(3304)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_3307_update)
HXLINE(3308)		this->super::update(elapsed);
HXLINE(3309)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(3309)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(3310)		if ((this->disableTime < 0)) {
HXLINE(3310)			this->disableTime = ( (Float)(0) );
            		}
HXLINE(3311)		if ((this->disableTime < 1)) {
HXLINE(3311)			this->set_alpha(this->disableTime);
            		}
            	}
