...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Mr.Bendy",d7,73,ae,60),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("56",61,2e,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("ShadowMario",e4,7d,20,5e));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Mr.Bendy",d7,73,ae,60));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("FNF vs Mr.Bendy",f8,f7,01,df));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("FNF vs Mr.Bendy",f8,f7,01,df))
