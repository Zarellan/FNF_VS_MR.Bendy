...
HXLINE( 137)		save->bind(HX_("controls_v2",65,e4,a2,26),::CoolUtil_obj::getSavePath(null()));
...
HXLINE( 271)		save->bind(HX_("controls_v2",65,e4,a2,26),::CoolUtil_obj::getSavePath(null()));
