...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_537_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",537,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_537_new)
HXLINE( 543)		this->folder = HX_("",00,00,00,00);
HXLINE( 542)		this->color = -7179779;
HXLINE( 541)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 540)		this->week = 0;
HXLINE( 539)		this->songName = HX_("",00,00,00,00);
HXLINE( 547)		this->songName = song;
HXLINE( 548)		this->week = week;
HXLINE( 549)		this->songCharacter = songCharacter;
HXLINE( 550)		this->color = color;
HXLINE( 551)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 552)		if (::hx::IsNull( this->folder )) {
HXLINE( 552)			this->folder = HX_("",00,00,00,00);
            		}
            	}
