...
HXLINE( 564)										ret = null();
            									...
            									break;
            									case (int)1: {
HXLINE( 564)										ret = (lua_toboolean(l,-1) != 0);
            									}
            									break;
            									case (int)3: {
HXLINE( 564)										ret = lua_tonumber(l,-1);
            									}
            									break;
            									case (int)4: {
HXLINE( 564)										ret = linc::lua::tostring(l,-1);
            									}
            									break;
            									case (int)5: {
HXLINE( 564)										bool array = true;
...
HXDLIN( 564)											while((lua_next(l,-2) != 0)){
HXLINE( 564)												int index = (lua_tointeger(l,-2) - 1);
HXDLIN( 564)												arr->set(index,::llua::Convert_obj::fromLua(l,-1));
HXDLIN( 564)												lua_pop(l,1);
            											}
HXDLIN( 564)											ret1 = arr;
            										}
...
HXDLIN( 564)											lua_pushnil(l);
HXDLIN( 564)											while((lua_next(l,-2) != 0)){
HXLINE( 564)												::String ret = ::Std_obj::string(::llua::Convert_obj::fromLua(l,-2));
HXDLIN( 564)												obj->hx::Anon_obj::Add(ret,::llua::Convert_obj::fromLua(l,-1));
HXDLIN( 564)												lua_pop(l,1);
            											}
HXDLIN( 564)											ret1 = obj;
            										}
...
HXLINE( 564)										ret = null();
            									...
            									break;
            									case (int)1: {
HXLINE( 564)										ret = (lua_toboolean(l,-2) != 0);
            									}
            									break;
            									case (int)3: {
HXLINE( 564)										ret = lua_tonumber(l,-2);
            									}
            									break;
            									case (int)4: {
HXLINE( 564)										ret = linc::lua::tostring(l,-2);
            									}
            									break;
            									case (int)5: {
HXLINE( 564)										bool array = true;
...
HXDLIN( 564)												::String ret1 = ::Std_obj::string(ret);
...
HXDLIN( 564)												obj->hx::Anon_obj::Add(ret1,ret2);
HXDLIN( 564)												lua_pop(l,1);
            											}
HXDLIN( 564)											ret1 = obj;
            										}
...
HXLINE( 567)		 ::Dynamic ret = ::Reflect_obj::callMethod(null(),cbf,args);
HXLINE( 569)		if (::hx::IsNotNull( ret )) {
HXLINE( 569)			::llua::Convert_obj::toLua(l,ret);
            		}
HXLINE( 572)		return 1;
            	}
