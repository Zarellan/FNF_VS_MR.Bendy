...
HXLINE(3366)		this->interp->variables->set(HX_("FlxG",b5,4b,97,2e),::hx::ClassOf< ::flixel::FlxG >());
HXLINE(3367)		this->interp->variables->set(HX_("FlxSprite",f7,d5,84,45),::hx::ClassOf< ::flixel::FlxSprite >());
HXLINE(3368)		this->interp->variables->set(HX_("FlxCamera",97,40,7b,39),::hx::ClassOf< ::flixel::FlxCamera >());
HXLINE(3369)		this->interp->variables->set(HX_("FlxTimer",13,ca,0f,cd),::hx::ClassOf< ::flixel::util::FlxTimer >());
HXLINE(3370)		this->interp->variables->set(HX_("FlxTween",b9,b4,4a,d6),::hx::ClassOf< ::flixel::tweens::FlxTween >());
HXLINE(3371)		this->interp->variables->set(HX_("FlxEase",60,c5,64,d3),::hx::ClassOf< ::flixel::tweens::FlxEase >());
HXLINE(3372)		this->interp->variables->set(HX_("PlayState",5d,83,c2,46),::hx::ClassOf< ::PlayState >());
HXLINE(3373)		this->interp->variables->set(HX_("game",f2,f3,5e,44),::PlayState_obj::instance);
HXLINE(3374)		this->interp->variables->set(HX_("Paths",0e,7b,84,50),::hx::ClassOf< ::Paths >());
HXLINE(3375)		this->interp->variables->set(HX_("Conductor",c7,77,a1,7b),::hx::ClassOf< ::Conductor >());
HXLINE(3376)		this->interp->variables->set(HX_("ClientPrefs",c5,55,e0,8a),::hx::ClassOf< ::ClientPrefs >());
HXLINE(3377)		this->interp->variables->set(HX_("Character",89,bb,a4,e3),::hx::ClassOf< ::Character >());
HXLINE(3378)		this->interp->variables->set(HX_("Alphabet",d3,38,ea,fa),::hx::ClassOf< ::Alphabet >());
HXLINE(3379)		this->interp->variables->set(HX_("CustomSubstate",82,cd,df,32),::hx::ClassOf< ::CustomSubstate >());
HXLINE(3381)		this->interp->variables->set(HX_("FlxRuntimeShader",6b,22,33,11),::hx::ClassOf< ::flixel::addons::display::FlxRuntimeShader >());
HXLINE(3383)		this->interp->variables->set(HX_("ShaderFilter",dd,08,30,bd),::hx::ClassOf< ::openfl::filters::ShaderFilter >());
HXLINE(3384)		this->interp->variables->set(HX_("StringTools",6a,db,63,03),::hx::ClassOf< ::StringTools >());
