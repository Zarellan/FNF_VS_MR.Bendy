...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		bool startLuasOnFolder(::String luaFile);
		::Dynamic startLuasOnFolder_dyn();

		 ::Dynamic callOnLuas(::String event,::cpp::VirtualArray args,::hx::Null< bool >  ignoreStops,::Array< ::String > exclusions,::cpp::VirtualArray excludeValues);
